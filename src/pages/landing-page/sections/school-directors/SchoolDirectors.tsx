...
export default function SchoolDirectors({ data = directorsData }) {
  return (
    <section className="school-directors">
      ...
      <div className="school-directors__container">
        ...
        <div className="school-directors__header">
          <span className="school-directors__title">{data.badge}</span>
          ...
          <p className="school-directors__subtitle">{data.subtitle}</p>
        </div>
